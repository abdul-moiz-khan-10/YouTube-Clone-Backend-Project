...
const logoutUser = asyncHandler(async (req, res) => {
    await User.findByIdAndUpdate(
        ...
        {
            $unset: {
                refreshToken: 1  // this removes the field from docuent
            }
        },
        {
            new: true
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    if (!username?.trim()) {
        throw new ApiError(400, "username is mmisiing")
    }
                ...
                pipeline: [
                    {
                        $lookup: {
                            ...
                            pipeline: [
                                {
                                    $project: { // ye project filed ko baher nikal ke bhi dekhn hai second stach per 
                                        username: 1,
                                        avatar: 1,
                                        fullname: 1
